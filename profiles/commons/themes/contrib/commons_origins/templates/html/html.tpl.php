...
<?php print $polyfills; ?>
    <?php if ($is_front): ?>
<link rel="stylesheet" href="/profiles/commons/themes/contrib/commons_origins/css/flexslider.css" type="text/css">
<script src="/profiles/commons/themes/contrib/commons_origins/scripts/jquery.flexslider-min.js"></script>
    <?php endif; ?>
</head>
